			...
			<div class="section_container">
				<nav>
					...
					<ul class="navigation show-mobile-nav">
						<li><a href="index.html">Add Watch</a></li>
						<li><a href="details.html">Delete Watch</a></li>
						<li><a href="items.html">Managers</a></li>
						<li><a href="gallery.html">Black Friday</a></li>
				...
				<div class="delete crud">
					...
					<form action="admin.php" method="post">
						...
						<?php /*
							...
							if ($_POST["nameD"]) {
								$addNameD = $_POST["nameD"];
								$addBrandD = $_POST["brandD"];
								$addCategoryD = $_POST["categoryD"];	
							}
							
							$query = "DELETE FROM `watches-list` WHERE `name`='$addNameD' and `brand`='$addBrandD' and `category`='$addCategoryD'";
							$result = $conn->query($query);
							if (!$result) {
							    trigger_error('Invalid query: ' . $conn->error);
							}
